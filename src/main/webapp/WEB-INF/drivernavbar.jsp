...
<%
    EasyCabSession driverNavbarSession = (EasyCabSession) session.getAttribute(EasyCabSession.ATTR_NAME);
    User driverNavbarUser = driverNavbarSession.getUser();
%> 
    ...
    <div class="collapse navbar-collapse text-right align-items-end flex-column">
        <div class="d-flex">
            <span class="navbar-text pr-2">
                Logged in as <%=driverNavbarUser.getName()%>
            </span>
